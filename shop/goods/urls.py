...
from .views import shoes, index, shoescart, view_cart, update_cart, remove_item_from_cart, display_info, order, popular, newest, delivery, sale, clothes, clothcart, money, money_back, accessories, accessory
...
urlpatterns = [
    ...
    path('accessories/<int:product_id>/', accessory, name='accessory'),
    ...
    path('accessories/add_to_cart/<int:product_id>/', accessory, name='accessory_add_to_cart'),
